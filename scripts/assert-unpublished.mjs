...
const codes = [...o.matchAll(/(?:npm )?error code (E\d+)/gi)].map((m) => m[1].toUpperCase())
if (
  !/E404|No match found for version/i.test(o) ||
  codes.some((c) => c !== 'E404') ||
  /ECONN|ETIMEDOUT|ENETUNREACH|EAI_AGAIN/i.test(o)
)
